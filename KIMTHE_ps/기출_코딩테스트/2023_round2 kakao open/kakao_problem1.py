    ...
    while day <= end_day:
        ...
        while rv_P1_list:
            ...
            while floor_record:
                ...
                while room <= room_cnt-amount+1:
                    #가능한 객실 탐색
                    room_pos = check_room_pos(floor,room,room+amount-1,check_in,check_out)
            ...
            if amount >= up_limit and day<dead and is_floor_pos == False: #많은 객실 예약일 때
